...
public class HttpConnection implements Connection {
    ...
    public static class Request extends HttpConnection.Base<Connection.Request> implements Connection.Request {
        ...
        private String defaultCharset = DataUtil.defaultCharset;
        ...
        public Connection.Request defaultCharset(String charset) {
            Validate.notNull(charset, "Charset must not be null");
            if (!Charset.isSupported(charset)) throw new IllegalCharsetNameException(charset);
        ...
        private static void serialiseRequestUrl(Connection.Request req) throws IOException {
            ...
            for (Connection.KeyVal keyVal : req.data()) {
                ...
                if (!first)
                    ...
                    first = false;
                url
                    .append(URLEncoder.encode(keyVal.key(), req.defaultCharset()))
                    .append('=')
                    .append(URLEncoder.encode(keyVal.value(), req.defaultCharset()));
            }
